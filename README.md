...
| [`yau-calabi-yau-fifty-years-reading-note-v0.md`](yau-calabi-yau-fifty-years-reading-note-v0.md) | original Chinese study note on canonical metrics, stability, mirror symmetry and higher-genus functions, with 23 source groups and an admission record | proposed document; catalog home `geometry`, lineage `external-reference` |
