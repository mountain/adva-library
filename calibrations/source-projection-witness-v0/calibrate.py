#!/usr/bin/env python3
"""One bounded disclosed-source witness calibration; preserves exact inputs."""
import copy
import json
import resource
import sys
...
from projection import build, check, digest, encode
...
def run():
    ...
    for label, m, n, value in [('first', 3, 4, 5), ('reuse', 5, 7, 17)]:
        ...
        assert judgment['status'] == 'RecordedSourceProjectionChecked'
    ...
    return {'schema': 'adva.record-projection-calibration.v0', 'status': 'FiniteRecordProjectionChecked',
